...
<table width="580" cellpadding="0" cellspacing="0" border="0">
    <tbody>
        <tr style="border-collapse:collapse">
            <td width="580" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                <p align="left" style="font-size:18px;line-height:24px;color:#8a0020;font-weight:bold;margin-top:0px;margin-bottom:18px;font-family:HelveticaNeue,sans-serif">New Customer Registration</p>
                    ...
                    <table border="0" cellpadding="5" cellspacing="0" width="100%" style="font-size:13px;font-family:'calibri',arial,verdana;line-height:1.4">
                      ...
                      <tr style="border-collapse:collapse">
                                <td style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                    <strong><strong>Customer ID:</strong></strong>
                                </td>
                                <td style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                {{encodeToBase64($data['id'])}}</td>
                         </tr>
                            ...
                            <tr style="border-collapse:collapse">
                                ...
                                <td style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                    <a href="mailto:{{@$data['email']}}" style="color:#0078be;font-weight:bold;text-decoration:none" target="_blank">{{@$data['email']}}</a>
                                </td>
                            </tr>
                            ...
                            <tr style="border-collapse:collapse">
                                ...
                                <td style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                    <a href="#" value="{{@$data['phone']}}" style="color:#0078be;font-weight:bold;text-decoration:none" target="_blank">{{@$data['phone']}}</a>
                                </td>
                            </tr>  
                        ...
                        <tr style="border-collapse:collapse">
                         ...
                         <tr style="border-collapse:collapse">
                                ...
                                <td style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                    {{@$data['street']}} {{@$data['another_street']}} {{@$data['city']}} {{@$data['state'] }} , {{@$data['country']}}</td>
                         </tr>


                <tr id="buttonRight" style="float:right;">
                   <a href="{{URL::to('/')}}/customer-is-ready-for-quotation?uul={{@encodeToBase64($data['id'])}}" class="btn btn-primary">Ready For Quotation</a>
                </tr>
...
<img src="https://www.google.co.in/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png" width="1" height="1" border="0" alt="" style="min-height:1px!important;width:1px!important;border-width:0!important;margin-top:0!important;margin-bottom:0!important;margin-right:0!important;margin-left:0!important;padding-top:0!important;padding-bottom:0!important;padding-right:0!important;padding-left:0!important;outline-style:none;text-decoration:none;display:block">
</div>
