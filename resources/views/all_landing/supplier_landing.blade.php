...
<div class="container">
  ...
  <h1>Supplier Related Visual</h1>     
	<div class="row">
		<div class="col-md-3">
          <div class="panel post">
            <a href="{{URL::to('show_all_supplier_data')}}"><span>{{$all_suppliers2345}}</span>All</a>  
          </div>
    </div>
...
<div class="col-md-3">
  <div class="panel car">
    <a href="{{URL::to('supplier_for_a_project')}}"><span>P</span>Projects</a>
  </div>
</div>
{{--
<div class="col-md-3">
  <div class="panel page">
    <a href="javascript:void();"><span>3 </span>Approved</a>
  </div>
</div>

<div class="col-md-3">
  <div class="panel page">
    <a href="{{URL::to('show_all_completed_jobs')}}"><span>3 </span>Follow</a>
  </div>
</div>
