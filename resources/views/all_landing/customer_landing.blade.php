...
<div class="container">
  ...
  <h1>Customer Related Visual</h1>     
	<div class="row">

{{-- 		<div class="col-md-3">
        <div class="panel post">
          <a href="{{URL::to('show_all_customers')}}"><span>5</span>All</a>  
        </div>
  </div> --}}

<div class="col-md-3">
  <div class="panel car">
    <a href="{{URL::to('all_customer_data')}}"><span>{{$allCustomer2345}}</span>All</a>
  </div>
</div>

<div class="col-md-3">
  <div class="panel page">
    <a href="{{URL::to('ready_for_quotation')}}"><span>{{$readyForQuotation2345}}</span>Ready</a>
  </div>
</div>

<div class="col-md-3">
  <div class="panel page">
    <a href="{{URL::to('hold_for_quotation')}}"><span>{{$holdFor2345}}</span>Follow</a>
  </div>
</div>
