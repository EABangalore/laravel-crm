      ...
      <div class="modal-content">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h2 class="text-uppercase text-muted">Register</h2></div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{URL::to('register')}}">  
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" placeholder="Enter Your Name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" placeholder="Enter Your Email id" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
...
<br>  <br><br>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" placeholder="Re-Enter The password" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
